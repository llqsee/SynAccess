...
class DataQualityExpert:
    ...
    def _build_prompt(self, validation_results):
        try:
            ...
            prompt += "SECTION_TITLE: Summary\n"
            prompt += "In the Summary section, include one bullet point titled 'AI Generated Score:' with these six scores (0-100): Overall Similarity Score, Multi-variable Score, Anomaly Burden Score, Bivariate Score, Structural Validity Score, and Univariate Similarity Score.\n"
            prompt += "SECTION_TITLE: Key Findings (50 words maximum)\n"
            prompt += "SECTION_TITLE: Statistical Quality (50 words maximum)\n"
            prompt += "SECTION_TITLE: Practical Usefulness (50 words maximum)\n"
            ...
            prompt += "SECTION_TITLE: Actionable Recommendations (3–5 recommendations, (50 words maximum))\n"
            prompt += "SECTION_TITLE: Risk Level (LOW, MEDIUM, HIGH) with justification (50 words maximum))\n\n"
            ...
            prompt += "IMPORTANT: Under each section title, provide 3-5 bullet points. Each bullet must begin with '- ' and contain no more than 12 words. Do not write long paragraphs.\n"
